/// <reference path="../3rdPartyLibs/typings/jquery/jquery.d.ts" />
/// <reference path="../3rdPartyLibs/typings/knockout/knockout.d.ts" />
/// <reference path="../Extensions/observableExtensions.ts" />
module RavenStudio {

    // Simple data table that provides infinite scrolling and plays
    // well with Knockout and Bootstrap. 
    ...
    export class DataTable {
        ...
        constructor(private tableSelector: string) {
            ...
            $(tableSelector).scroll(() => this.loadMoreIfNeeded());
        }
